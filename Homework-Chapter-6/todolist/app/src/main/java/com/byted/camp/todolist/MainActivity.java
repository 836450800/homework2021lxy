...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notesAdapter = new NoteListAdapter(new NoteOperator() {
            ...
            public void deleteNote(Note note) {
                ...
                int deleteRows = database.delete(TodoContract.TodoNote.Name, selection, selectionArgs);
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        Cursor cursor=null;
        try{
            cursor = database.query(TodoContract.TodoNote.Name,
                    null,
                    null,
                    null,
                    null,
            ...
            while(cursor.moveToNext()){
                ...
                int date = cursor.getInt(cursor.getColumnIndex(TodoContract.TodoNote.Date));
